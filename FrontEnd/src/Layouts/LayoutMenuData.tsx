...
const Navdata = () => {
    ...
    const [isLabelProject, setIsLabelProject] = useState<boolean>(false);
    ...
    useEffect(() => {
        ...
        if (iscurrentState !== 'Label') {
            setIsLabelProject(false);
        }
    }, [
        history,
        iscurrentState,
    ...
    const menuItems: any = [
        ...
        },
        {
            ...
            click: function (e: any) {
                e.preventDefault();
                setIsLabelProject(!isLabelProject);
                setIscurrentState('LabelProject');
                updateIconSidebar(e);
            },
            stateVariables: isLabelProject,
            subItems: [
                { id: "labelProject", label: "Project", link: "/labelProject", parentId: "LabelProject" },
            ],
        },
        // {
        //     id: "dashboard",
